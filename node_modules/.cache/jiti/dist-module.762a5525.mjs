...
const { resolve, resolvePath } = (0, _kit.createResolver)("file:///Users/maxi/repros/nuxthub-839/node_modules/.pnpm/@nuxthub+core@0.10.6_db0@0.3.4_ioredis@5.9.3_magicast@0.5.2/node_modules/@nuxthub/core/dist/module.mjs");
  ...
  try {
    ...
    if (dialect === "postgresql") {
      ...
      if (driver === "d1-http") {
        ...
        const d1Files = await (0, _tinyglobby.glob)(".wrangler/state/v3/d1/miniflare-D1DatabaseObject/*.sqlite", {
